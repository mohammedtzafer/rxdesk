...
export default function PrescriptionsPage() {
  ...
  if (error) {
    return (
      <div>
        <h1 className="text-[28px] sm:text-[40px] font-semibold leading-[1.1] tracking-tight text-foreground">Prescriptions</h1>
    ...
    <div>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2 items-center">
          <select
            ...
            className="h-9 rounded-lg border border-border px-3 text-[14px] bg-card"
          >
      ...
      {!hasData ? (
        <div className="mt-8 bg-card rounded-xl p-12 text-center">
          ...
          <h2 className="mt-4 text-[21px] font-bold text-foreground">No prescription data yet</h2>
        ...
        <>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-card rounded-lg p-5">
              ...
              <p className="text-[12px] text-muted-foreground mt-1">Last 30 days</p>
            </div>
          </div>
              ...
              {data!.topPrescribers.map((p, i) => {
                ...
                return (
                  <div key={p.npi} className="flex items-center gap-3">
                    <span className="w-6 text-[12px] text-muted-foreground/60 text-right">
                      {i + 1}
                    </span>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-[14px] text-foreground">{p.name}</span>
                        <span className="text-[14px] font-medium text-foreground">{p.count}</span>
                      </div>
