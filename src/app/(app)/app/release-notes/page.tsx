...
export default function ReleaseNotesPage() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-[40px] font-semibold leading-[1.1] tracking-tight text-[#1d1d1f]">Release notes</h1>
        <p className="mt-2 text-[17px] text-[rgba(0,0,0,0.48)]">What's new in RxDesk.</p>
      </div>
                ...
                <div className="bg-white rounded-xl p-5">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                        ...
                        <span
                          className={`text-[11px] font-semibold px-2 py-0.5 rounded-full ${
                            i === 0
                              ...
                              : "bg-[rgba(0,0,0,0.05)] text-[rgba(0,0,0,0.48)]"
                          }`}
                        >
                          {release.version}
                        </span>
                      ...
                      <h2 className="text-[17px] font-semibold text-[#1d1d1f] mt-1">{release.title}</h2>
                    </div>
                    <span className="text-[12px] text-[rgba(0,0,0,0.48)] shrink-0 pt-0.5">{release.date}</span>
                  </div>
