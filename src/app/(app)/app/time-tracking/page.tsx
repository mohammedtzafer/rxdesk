...
export default function TimeTrackingPage() {
  ...
  return (
    <div>
      ...
      {/* Clock in/out */}
      <div className="mt-6 bg-white rounded-xl p-6 text-center">
        <button
          onClick={handleClock}
        ...
        <p className="mt-2 text-[14px] text-[rgba(0,0,0,0.48)]">
      ...
      {/* Recent entries */}
      <div className="mt-6">
        <h2 className="text-[17px] font-semibold text-[#1d1d1f]">Recent entries (last 7 days)</h2>
        <div className="mt-3 bg-white rounded-xl overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              <Clock className="w-12 h-12 mx-auto text-[rgba(0,0,0,0.15)]" />
              <h3 className="mt-4 text-[21px] font-bold text-[#1d1d1f]">No time entries</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[rgba(0,0,0,0.05)]">
                  ...
                  <th className="text-left px-4 py-2.5 text-[12px] font-semibold text-[rgba(0,0,0,0.48)] uppercase hidden lg:table-cell">
                    Note
                  </th>
                </tr>
              </thead>
              <tbody>
                {entries.map((entry) => (
                  <tr key={entry.id} className="border-b border-[rgba(0,0,0,0.03)]">
                    ...
                    <td className="px-4 py-2.5 text-[14px] text-[#1d1d1f] font-mono">
                    ...
                    <td className="px-4 py-2.5 text-[14px] text-[rgba(0,0,0,0.48)] hidden lg:table-cell truncate max-w-[200px]">
                      {entry.note || "—"}
                    </td>
                  </tr>
                ))}
